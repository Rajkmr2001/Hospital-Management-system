...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: inherit; }
    :hospit27__PZjn81Jvd6McFpdoV7B4JC04nuao4p2c { --primary: #2563eb; --primary-light: #60a5fa; --accent: #10b981; --bg: #f8fafc; --card-bg: #fff; --navbar-bg: #fff; --navbar-shadow: 0 2px 12px rgba(37,99,235,0.07); --text: #222; --muted: #64748b; --radius: 18px; --shadow: 0 4px 24px rgba(37,99,235,0.10); }
