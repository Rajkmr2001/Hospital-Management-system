...
-- CLEANED VERSION FOR INFINITYFREE HOSTING (CREATE VIEW statements removed)
...
-- 6. Create a view for patient dashboard data (COMMENTED OUT FOR INFINITYFREE COMPATIBILITY)
-- InfinityFree free plan does not support CREATE VIEW statements
-- If you need this functionality, consider upgrading to a paid plan or implement as a stored procedure
/*
